...
class TestResolveBatchAttach(unittest.TestCase):
    ...
    def test_bulk_no_attach(self) -> None:
        self.assertFalse(
            resolve_batch_attach_decision(
    ...
    def test_bulk_prompt_once(self, mock_prompt: unittest.mock.MagicMock) -> None:
    ...
    def test_bulk_dry_run_does_not_prompt(self) -> None:
        decision = resolve_batch_attach_decision(
